  ...
  <div class="wrapper">
    <div class="content">
      <div class="center">
        ...
        <div class="text1">System is temporarily unavailable</div>

        <!-- <div class="text1">What's happening?</div> -->
        <div class="text2 center">
          Scheduled maintenance is currently in progress. We'll be back shortly.
        </div>
      </div>
    </div>
  </div>
...
.wrapper {
  ...
  background: linear-gradient(
    176deg,
    rgba(20, 116, 82, 1) 0%,
    rgba(87, 199, 133, 1) 49%,
    rgba(154, 212, 157, 1) 100%,
    rgba(235, 228, 185, 1) 100%
  );
  height: 100vh;
  width: 100vw;
}
...
#gear2 {
  height: 100px;
  width: 100px;
  animation: rotate_counter_clockwise 10s linear infinite;
}
